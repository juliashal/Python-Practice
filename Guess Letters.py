...
As a bonus, keep track of the letters the player guessed and display a different message if the player tries to guess that letter again. Remember to stop the game when all the letters have been guessed correctly! 
...
hidden_word = "EVAPORATE"

user_word = ['_']*len(hidden_word)
...
print(f"You guessed a word in {guess_count} attempts")
